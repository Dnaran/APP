...
import com.example.administrator.myapplication.map.MySensorEventListener;
import com.example.administrator.myapplication.map.PoiOverlay;
...
public class MapActivity extends Activity implements OnGetGeoCoderResultListener {
     ...
     * 全局变量
     */
    private static final String APP_FOLDER_NAME = "travelapp";    //app在SD卡中的目录名
    public static List<Activity> activityList = new LinkedList<>();  //节点数目
    private final String TTS_API_KEY = "11378900";               //语音播报api_key
        ...
        goButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!BaiduNaviManager.isNaviInited()) {
                    Toast.makeText(MapActivity.this, "授权失败", Toast.LENGTH_SHORT).show();
                    return;
                }
                /**
                 * 获取该点的坐标位置
                ...
                Toast.makeText(MapActivity.this, "开始获取起点和终点", Toast.LENGTH_SHORT).show();
                ...
                if (sNode != null && eNode != null) {
                    ...
                    BaiduNaviManager
                            .getInstance()
                            .launchNavigator(
                                    MapActivity.this,               //建议是应用的主Activity
...
//                showToastMsg(authinfo);
    ...
    private class PoiSearchListener implements OnGetPoiSearchResultListener {
        ...
        public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
            ...
            if (poiDetailResult.error == SearchResult.ERRORNO.NO_ERROR) {
                ...
                Toast.makeText(MapActivity.this, "目的地设为地图中心", Toast.LENGTH_LONG).show();
                return;
            }
    ...
    private class SuggestionResultListener implements OnGetSuggestionResultListener {
        ...
        public void onGetSuggestionResult(final SuggestionResult suggestionResult) {
            ...
            adapter = new ArrayAdapter<String>(MapActivity.this, android.R.layout.simple_dropdown_item_1line, suggest);
    ...
    public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
        ...
        public void onJumpToNavigator() {
             ...
             * 导航activity
             */
            Intent intent = new Intent(MapActivity.this, GuideActivity.class);
            Bundle bundle = new Bundle();
