...
/**
 * Created by Cynthia on 2018/6/10.
 */
public class BNEventDialog extends Dialog {
    ...
    private TextView mRemainTimeTx;   //时间
    private TextView mRemainDistanceTx; // 剩余总距离
    private TextView mCurrentSpeedTx;   //速度

    private ImageView mTurnImage;  //转向图标
    private TextView mGoDistanceTx;   //距离下一个点的距离
    private TextView mNextRoadTx;  //下一个节点名
