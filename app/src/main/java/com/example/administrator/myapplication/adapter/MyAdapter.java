...
import com.example.administrator.myapplication.interfaces.FilterListener;
...
public class MyAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_ss = (TextView) convertView.findViewById(R.id.textView_search);
            //holder = new ViewHolder();
            //holder.id = (TextView) convertView.findViewById(R.id.id_search);
