package com.example.administrator.myapplication.dp;
...
public class MainDimenSax {
    //源dimens文件的dimen集合
    public static ArrayList<DimenBean> list;
    //当前根目录：D:/android/
    public static String baseDirPath;
    //基准dp，比喻：360dp
    public static float baseDP;
    //基准dimens.xml文件路径，比喻：D:/android/res/values/dimens.xml
    public static String baseDimenFilePath;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < args.length; i++) {
            ...
            //创建当前dp对应的dimens文件目录
            String outPutDir = baseDirPath + "/values-w" + args[i] + "dp/";
     ...
     * @return
     */
    public static String countValue(String oldValue, float multiple) {
        //数据格式化对象
